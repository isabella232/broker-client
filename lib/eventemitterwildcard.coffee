...
# Copy of KDEventEmitterWildCard from kd.js ~ GG
# https://raw.githubusercontent.com/koding/kd/master/lib/core/eventemitterwildcard.coffee

module.exports = class EventEmitterWildcard extends EventEmitter
